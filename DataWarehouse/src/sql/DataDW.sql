...
(4, 'Sony ZV-1 II Vlog On The Go Edition (Chính hãng)', 3, 'https://zshop.vn/images/thumbnails/460/460/detailed/170/SONY_ZV1_II__VL.jpg', '- Dành cho vlogger và người sáng tạo nội dung, - Cảm biến Exmor RS BSI CMOS 1" 20.1MP, - Ống kính góc rộng tương đương 18-50mm f/1.8-4, - Quay video 4K30p UHD với HLG & S-Log3/2, - Màn hình cảm ứng LCD 3", xoay lật, - Điều khiển phơi sáng & lấy nét cảm ứng trực quan, - Lấy nét Real-Time Tracking & Eye AF, - Cần gạt bokeh, Face Priority AE, - Thiết lập Cinematic Vlog, chế độ quay S&Q, - Chế độ giới thiệu sản phẩm crawl_data.Product Showcase'),
